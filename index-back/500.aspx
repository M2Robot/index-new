...
<head>
    ...
    <meta property="og:url" content="https://www.mrrobot.ga/500.html"/>
    ...
    <meta property="og:description" content="Internal Server Error 500 " />
    ...
    <link rel="stylesheet" href="assets/mouse_animate/style.css">
    <script src="assets/mouse_animate/main.js"></script>	
    <link rel="apple-touch-icon" type="image/png" sizes="180x180" href="images/icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="images/icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="images/icons/favicon-16x16.png">
    <link rel="manifest" href="images/icons/site.webmanifest">
    <link rel="mask-icon" href="images/icons/safari-pinned-tab.svg" color="#1f1f1f">
    <meta name="apple-mobile-web-app-title" content="MrRobot.dev">
    <meta name="application-name" content="MrRobot.dev">
...
<body oncontextmenu="return false">
  ...
  <div class="container">
        <div class="error">
            <h1>500</h1>
            <small>Internal Server Error</small><br>
            <b>Oops, something broke when loading the page you requested! This is usually caused by bad .htaccess code or an error in your <span class="error-red">&nbsp; PHP &nbsp;</span>  code.</b><br><br>
               <a onclick="window.location.href='https://www.mrrobot.ga/en';" target="_self">
